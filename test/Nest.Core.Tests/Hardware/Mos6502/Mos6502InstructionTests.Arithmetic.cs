    ...
    public partial class Mos6502Tests
    {
        public class Adc
        {
            ...
            public void NoCarry() => new Mos6502TestBuilder()
                ...
                .WithResultState(a: 0x66, pc: 0x02)
                .Run();
            ...
            public void WithCarryIn() => new Mos6502TestBuilder()
                ...
                .WithResultState(a: 0x67, pc: 0x02)
                .Run();
            ...
            public void SetsCarryFlagWhenResultOverflows() => new Mos6502TestBuilder()
                ...
                .WithResultState(a: 0x01, pc: 0x02, p: Mos6502Flags.PowerUp | Mos6502Flags.Carry)
                .Run();
            ...
            public void SetsZeroFlagWhenResultIsZero() => new Mos6502TestBuilder()
                ...
                .WithResultState(a: 0x00, pc: 0x02, p: Mos6502Flags.PowerUp | Mos6502Flags.Zero | Mos6502Flags.Carry)
                .Run();
            ...
            public void SetsNegativeBitWhenResultIsNegative() => new Mos6502TestBuilder()
                ...
                .WithResultState(a: 0x81, pc: 0x02, p: Mos6502Flags.PowerUp | Mos6502Flags.Negative | Mos6502Flags.Overflow)
                .Run();
            ...
            public void SetsOverflowBitIfSignBitChangesDespiteBothValuesHavingSameSign() => new Mos6502TestBuilder()
                ...
                .WithResultState(a: 0xA8, pc: 0x02, p: Mos6502Flags.PowerUp | Mos6502Flags.Overflow | Mos6502Flags.Negative)
                .Run();
        }
        ...
        public class And
        {
            ...
            public void PerformsBitwiseAnd() => new Mos6502TestBuilder()
                ...
                .WithResultState(a: 0b0000_0101, pc: 0x02)
                .Run();
            ...
            public void SetsZeroFlagIfResultIsZero() => new Mos6502TestBuilder()
                ...
                .WithResultState(a: 0x00, pc: 0x02, p: Mos6502Flags.PowerUp | Mos6502Flags.Zero)
                .Run();
            ...
            public void SetsNegativeFlagIfBit7IsSet() => new Mos6502TestBuilder()
                ...
                .WithInitialState(a: 0b1111_0000)
                .WithResultState(a: 0b1010_0000, pc: 0x02, p: Mos6502Flags.PowerUp | Mos6502Flags.Negative)
                .Run();
        }
        ...
        public class Asl {
            ...
            public void ShiftsAccumulatorLeft() => new Mos6502TestBuilder()
                ...
                .WithResultState(a: 0b0001_1110, pc: 0x01)
                .Run();
            ...
            public void CarryOut() => new Mos6502TestBuilder()
                ...
                .WithResultState(a: 0b0110_0000, pc: 0x01, p: Mos6502Flags.PowerUp | Mos6502Flags.Carry)
                .Run();
            ...
            public void SetsZeroFlagIfAccumulatorBecomesZero() => new Mos6502TestBuilder()
                ...
                .WithResultState(a: 0x00, pc: 0x01, p: Mos6502Flags.PowerUp | Mos6502Flags.Zero | Mos6502Flags.Carry)
                .Run();
            ...
            public void DoesNotSetZeroFlagIfResultIsZeroButTargetIsNotAccumulator() => new Mos6502TestBuilder()
                ...
                .WithInitialState()
                .WithResultState(pc: 0x03, p: Mos6502Flags.PowerUp | Mos6502Flags.Carry)
            ...
            public void SetsNegativeFlagIfResultIsNegative() => new Mos6502TestBuilder()
                ...
                .WithInitialState()
                .WithResultState(pc: 0x03, p: Mos6502Flags.PowerUp | Mos6502Flags.Negative)
